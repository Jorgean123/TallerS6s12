...
<section class="panel catalog-panel"><div class="section-heading"><div><h2>Productos de tecnología</h2><p class="muted mb-0">Datos de demostración enviados por el Servlet.</p></div><span class="pill">${totalProductos} productos</span></div><div class="table-responsive"><table class="table align-middle"><thead><tr><th scope="col">Código</th><th scope="col">Producto</th><th scope="col">Precio</th><th scope="col">Stock</th><th scope="col">Estado</th></tr></thead><tbody>
<c:forEach var="producto" items="${productos}">
  <tr>
    ...
    <td><c:choose><c:when test="${producto.stock gt 0}"><span class="status good">Disponible</span></c:when><c:otherwise><span class="status bad">Agotado</span></c:otherwise></c:choose></td>
  </tr>
</c:forEach>
